...
class OrganisationRegistrationAgency(models.TextChoices):
    ...
    AJMAN_CHAMBER_OF_COMMERCE_AND_INDUSTRY = (
        "AE-ACCI",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency",
    ...
    AJMAN_FREE_ZONE_AUTHORITY = (
        "AE-AFZ",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Ajman Free Zone Authority"
        ),
    )
    ...
    AUSTRIA_COMPANY_REGISTER = (
        "AT-FB",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Austria Company Register"
        ),
    )
    ...
    COMMERCIAL_REGISTER = (
        "BG-EIK",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Commercial Register"
        ),
    )
    UNIQUE_TAX_IDENTIFIER = (
        "BJ-IFU",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Unique Tax Identifier"
        ),
    )
    ...
    CORPORATIONS_CANADA = (
        "CA-CC",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Corporations Canada"
        ),
    )
    CANADIAN_REVENUE_AGENCY = (
        "CA-CRA_ACR",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Canadian Revenue Agency "
        ),
    )
    ...
    CORPORATE_REGISTRY_OFFICE = (
        "CA_AB-ABT",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Corporate Registry Office "
        ),
    )
    ...
    CORPORATE_REGISTRY = (
        "CA_NB-NWB_NOB",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Corporate Registry "
        ),
    )
    ...
    QUEBEC_BUSINESS_REGISTRAR = (
        "CA_QC-QBC",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Quebec Business Registrar "
        ),
    )
    ...
    YUKON_CORPORATE_AFFAIRS = (
        "CA_YT-YKT",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Yukon Corporate Affairs "
        ),
    )
    ...
    CHARITY_COMMISSION = (
        "GB-CHC",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Charity Commission"
        ),
    )
    COMPANIES_HOUSE = (
        "GB-COH",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Companies House"
        ),
    )
    ...
    MUTUALS_PUBLIC_REGISTER = (
        "GB-MPR",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Mutuals Public Register"
        ),
    )
    ...
    HM_REVENUE_AND_CUSTOMS = (
        "GB-REV",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "HM Revenue and Customs"
        ),
    )
    SCOTTISH_CHARITY_REGISTER = (
        "GB-SC",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Scottish Charity Register"
        ),
    )
    ...
    GUERNSEY_REGISTRY = (
        "GG-RCE",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Guernsey Registry"
        ),
    )
    ...
    CROATIA_COURT_REGISTER = (
        "HR-OIB",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Croatia Court Register"
        ),
    )
    ...
    MINISTRY_OF_HOME_AFFAIRS = (
        "ID-KDN",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Ministry of Home Affairs "
        ),
    )
    ...
    NGO_S_COORDINATION_BOARD = (
        "KE-NCB",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "NGO's Coordination Board"
        ),
    )
    REGISTAR_OF_COMPANIES = (
        "KE-RCO",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Registar of Companies"
        ),
    )
    REGISTRAR_OF_SOCIETIES = (
        "KE-RSO",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Registrar of Societies"
        ),
    )
    ...
    TAX_IDENTIFICATION_NUMBER = (
        "ML-NIF",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Tax Identification Number"
        ),
    )
    ...
    MALAWI_REVENUE_AUTHORITY = (
        "MW-MRA",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Malawi Revenue Authority"
        ),
    )
    NGO_BOARD_OF_MALAWI = (
        "MW-NBM",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "NGO Board of Malawi"
        ),
    )
    ...
    FEDERAL_TAXPAYERS_REGISTRY = (
        "MX-RFC",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Federal Taxpayers Registry"
        ),
    )
    ...
    BRØNNØYSUNDREGISTRENE = (
        "NO-BRC",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Brønnøysundregistrene"
        ),
    )
    COMPANY_REGISTRAR_OFFICE = (
        "NP-CRO",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Company Registrar Office"
        ),
    )
    ...
    PORTAL_OF_PUBLIC_SERVICES = (
        "PT-NIPPC",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Portal of Public Services"
        ),
    )
    ...
    BOLAGSVERKET = (
        "SE-BLV",
        pgettext_lazy("IATI codelist OrganisationRegistrationAgency", "Bolagsverket "),
    )
    ...
    TANZANIA_REVENUE_AGENCY = (
        "TZ-TRA",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Tanzania Revenue Agency"
        ),
    )
    UNITED_STATE_REGISTER = (
        "UA-EDR",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "United State Register "
        ),
    )
    ...
    EXAMPLE_DATA_PREFIX = (
        "XE-EXAMPLE",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Example Data Prefix"
        ),
    )
    ...
    WIKIDATA = (
        "XI-WIKIDATA",
        pgettext_lazy("IATI codelist OrganisationRegistrationAgency", "Wikidata"),
    )
    ...
    REGISTRAR_OF_DEEDS = (
        "ZW-ROD",
        pgettext_lazy(
            "IATI codelist OrganisationRegistrationAgency", "Registrar of Deeds"
        ),
    )
