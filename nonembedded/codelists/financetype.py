...
class FinanceType(models.IntegerChoices):
    ...
    GNI__GROSS_NATIONAL_INCOME = (
        1,
        pgettext_lazy("FinanceType", "GNI: Gross National Income"),
    )
    STANDARD_GRANT = (
        110,
        pgettext_lazy("FinanceType", "Standard grant"),
    )
    GUARANTEES_INSURANCE = (
        1100,
        pgettext_lazy("FinanceType", "Guarantees/insurance"),
    )
    SUBSIDIES_TO_NATIONAL_PRIVATE_INVESTORS = (
        111,
        pgettext_lazy("FinanceType", "Subsidies to national private investors"),
    )
    ODA___GNI = (
        2,
        pgettext_lazy("FinanceType", "ODA % GNI"),
    )
    INTEREST_SUBSIDY = (
        210,
        pgettext_lazy("FinanceType", "Interest subsidy"),
    )
    ...
    TOTAL_FLOWS___GNI = (
        3,
        pgettext_lazy("FinanceType", "Total Flows % GNI"),
    )
    CAPITAL_SUBSCRIPTION_ON_DEPOSIT_BASIS = (
        310,
        pgettext_lazy("FinanceType", "Capital subscription on deposit basis"),
    )
    CAPITAL_SUBSCRIPTION_ON_ENCASHMENT_BASIS = (
        311,
        pgettext_lazy("FinanceType", "Capital subscription on encashment basis"),
    )
    POPULATION = (
        4,
        pgettext_lazy("FinanceType", "Population"),
    )
    AID_LOAN_EXCLUDING_DEBT_REORGANISATION = (
        410,
        pgettext_lazy("FinanceType", "Aid loan excluding debt reorganisation"),
    )
    ...
    LOAN_IN_A_JOINT_VENTURE_WITH_THE_RECIPIENT = (
        412,
        pgettext_lazy("FinanceType", "Loan in a joint venture with the recipient"),
    )
    LOAN_TO_NATIONAL_PRIVATE_INVESTOR = (
        413,
        pgettext_lazy("FinanceType", "Loan to national private investor"),
    )
    LOAN_TO_NATIONAL_PRIVATE_EXPORTER = (
        414,
        pgettext_lazy("FinanceType", "Loan to national private exporter"),
    )
    STANDARD_LOAN = (
        421,
        pgettext_lazy("FinanceType", "Standard loan"),
    )
    REIMBURSABLE_GRANT = (
        422,
        pgettext_lazy("FinanceType", "Reimbursable grant"),
    )
    BONDS = (
        423,
        pgettext_lazy("FinanceType", "Bonds"),
    )
    ASSET_BACKED_SECURITIES = (
        424,
        pgettext_lazy("FinanceType", "Asset-backed securities"),
    )
    OTHER_DEBT_SECURITIES = (
        425,
        pgettext_lazy("FinanceType", "Other debt securities"),
    )
    SUBORDINATED_LOAN = (
        431,
        pgettext_lazy("FinanceType", "Subordinated loan"),
    )
    PREFERRED_EQUITY = (
        432,
        pgettext_lazy("FinanceType", "Preferred equity"),
    )
    OTHER_HYBRID_INSTRUMENTS = (
        433,
        pgettext_lazy("FinanceType", "Other hybrid instruments"),
    )
    NON_BANKS_GUARANTEED_EXPORT_CREDITS = (
        451,
        pgettext_lazy("FinanceType", "Non-banks guaranteed export credits"),
    )
    ...
    BANK_EXPORT_CREDITS = (
        453,
        pgettext_lazy("FinanceType", "Bank export credits"),
    )
    COMMON_EQUITY = (
        510,
        pgettext_lazy("FinanceType", "Common equity"),
    )
    ...
    OTHER_ACQUISITION_OF_EQUITY = (
        512,
        pgettext_lazy("FinanceType", "Other acquisition of equity"),
    )
    SHARES_IN_COLLECTIVE_INVESTMENT_VEHICLES = (
        520,
        pgettext_lazy("FinanceType", "Shares in collective investment vehicles"),
    )
    REINVESTED_EARNINGS = (
        530,
        pgettext_lazy("FinanceType", "Reinvested earnings"),
    )
    DEBT_FORGIVENESS__ODA_CLAIMS__P_ = (
        610,
        pgettext_lazy("FinanceType", "Debt forgiveness:  ODA claims (P)"),
    )
    DEBT_FORGIVENESS__ODA_CLAIMS__I_ = (
        611,
        pgettext_lazy("FinanceType", "Debt forgiveness: ODA claims (I)"),
    )
    DEBT_FORGIVENESS__OOF_CLAIMS__P_ = (
        612,
        pgettext_lazy("FinanceType", "Debt forgiveness: OOF claims (P)"),
    )
    DEBT_FORGIVENESS__OOF_CLAIMS__I_ = (
        613,
        pgettext_lazy("FinanceType", "Debt forgiveness: OOF claims (I)"),
    )
    DEBT_FORGIVENESS__PRIVATE_CLAIMS__P_ = (
        614,
        pgettext_lazy("FinanceType", "Debt forgiveness:  Private claims (P)"),
    )
    DEBT_FORGIVENESS__PRIVATE_CLAIMS__I_ = (
        615,
        pgettext_lazy("FinanceType", "Debt forgiveness:  Private claims (I)"),
    )
    DEBT_FORGIVENESS__OOF_CLAIMS__DSR_ = (
        616,
        pgettext_lazy("FinanceType", "Debt forgiveness: OOF claims (DSR)"),
    )
    DEBT_FORGIVENESS__PRIVATE_CLAIMS__DSR_ = (
        617,
        pgettext_lazy("FinanceType", "Debt forgiveness:  Private claims (DSR)"),
    )
    DEBT_FORGIVENESS__OTHER = (
        618,
        pgettext_lazy("FinanceType", "Debt forgiveness: Other"),
    )
    DEBT_RESCHEDULING__ODA_CLAIMS__P_ = (
        620,
        pgettext_lazy("FinanceType", "Debt rescheduling: ODA claims (P)"),
    )
    DEBT_RESCHEDULING__ODA_CLAIMS__I_ = (
        621,
        pgettext_lazy("FinanceType", "Debt rescheduling: ODA claims (I)"),
    )
    DEBT_RESCHEDULING__OOF_CLAIMS__P_ = (
        622,
        pgettext_lazy("FinanceType", "Debt rescheduling: OOF claims (P)"),
    )
    DEBT_RESCHEDULING__OOF_CLAIMS__I_ = (
        623,
        pgettext_lazy("FinanceType", "Debt rescheduling: OOF claims (I)"),
    )
    DEBT_RESCHEDULING__PRIVATE_CLAIMS__P_ = (
        624,
        pgettext_lazy("FinanceType", "Debt rescheduling:  Private claims (P)"),
    )
    DEBT_RESCHEDULING__PRIVATE_CLAIMS__I_ = (
        625,
        pgettext_lazy("FinanceType", "Debt rescheduling:  Private claims (I)"),
    )
    DEBT_RESCHEDULING__OOF_CLAIMS__DSR_ = (
        626,
        pgettext_lazy("FinanceType", "Debt rescheduling: OOF claims (DSR)"),
    )
    DEBT_RESCHEDULING__PRIVATE_CLAIMS__DSR_ = (
        627,
        pgettext_lazy("FinanceType", "Debt rescheduling:  Private claims (DSR)"),
    )
    ...
    DEBT_FORGIVENESS__EXPORT_CREDIT_CLAIMS__DSR_ = (
        635,
        pgettext_lazy("FinanceType", "Debt forgiveness:  export credit claims (DSR)"),
    )
    DEBT_RESCHEDULING__EXPORT_CREDIT_CLAIMS__P_ = (
        636,
        pgettext_lazy("FinanceType", "Debt rescheduling:  export credit claims (P)"),
    )
    DEBT_RESCHEDULING__EXPORT_CREDIT_CLAIMS__I_ = (
        637,
        pgettext_lazy("FinanceType", "Debt rescheduling:  export credit claims (I)"),
    )
    ...
    BANK_BONDS = (
        810,
        pgettext_lazy("FinanceType", "Bank bonds"),
    )
    NON_BANK_BONDS = (
        811,
        pgettext_lazy("FinanceType", "Non-bank  bonds"),
    )
    OTHER_BANK_SECURITIES_CLAIMS = (
        910,
        pgettext_lazy("FinanceType", "Other bank securities/claims"),
    )
    OTHER_NON_BANK_SECURITIES_CLAIMS = (
        911,
        pgettext_lazy("FinanceType", "Other non-bank securities/claims"),
    )
    PURCHASE_OF_SECURITIES_FROM_ISSUING_AGENCIES = (
        912,
        pgettext_lazy("FinanceType", "Purchase of securities from issuing agencies"),
    )
