...
class CRSChannelCode(models.IntegerChoices):
    PUBLIC_SECTOR_INSTITUTIONS = (
        10000,
        pgettext_lazy("CRSChannelCode", "Public Sector Institutions"),
    )
    DONOR_GOVERNMENT = (
        11000,
        pgettext_lazy("CRSChannelCode", "Donor Government"),
    )
    CENTRAL_GOVERNMENT = (
        11001,
        pgettext_lazy("CRSChannelCode", "Central Government"),
    )
    LOCAL_GOVERNMENT = (
        11002,
        pgettext_lazy("CRSChannelCode", "Local Government"),
    )
    PUBLIC_CORPORATIONS = (
        11003,
        pgettext_lazy("CRSChannelCode", "Public corporations"),
    )
    OTHER_PUBLIC_ENTITIES_IN_DONOR_COUNTRY = (
        11004,
        pgettext_lazy("CRSChannelCode", "Other public entities in donor country"),
    )
    RECIPIENT_GOVERNMENT = (
        12000,
        pgettext_lazy("CRSChannelCode", "Recipient Government"),
    )
    CENTRAL_GOVERNMENT = (
        12001,
        pgettext_lazy("CRSChannelCode", "Central Government"),
    ...
    OTHER_PUBLIC_ENTITIES_IN_RECIPIENT_COUNTRY = (
        12004,
        pgettext_lazy("CRSChannelCode", "Other public entities in recipient country"),
    )
    ...
    INTERNATIONAL_NGO = (
        21000,
        pgettext_lazy("CRSChannelCode", "International NGO"),
    )
    ...
    LATIN_AMERICAN_COUNCIL_FOR_SOCIAL_SCIENCES = (
        21003,
        pgettext_lazy("CRSChannelCode", "Latin American Council for Social Sciences"),
    )
    ...
    DEVELOPMENT_GATEWAY_FOUNDATION = (
        21006,
        pgettext_lazy("CRSChannelCode", "Development Gateway Foundation"),
    )
    ENVIRONMENTAL_LIAISON_CENTRE_INTERNATIONAL = (
        21007,
        pgettext_lazy("CRSChannelCode", "Environmental Liaison Centre International"),
    )
    EUROSTEP = (
        21008,
        pgettext_lazy("CRSChannelCode", "Eurostep"),
    )
    FORUM_FOR_AGRICULTURAL_RESEARCH_IN_AFRICA = (
        21009,
        pgettext_lazy("CRSChannelCode", "Forum for Agricultural Research in Africa"),
    )
    FORUM_FOR_AFRICAN_WOMEN_EDUCATIONALISTS = (
        21010,
        pgettext_lazy("CRSChannelCode", "Forum for African Women Educationalists"),
    )
    GLOBAL_CAMPAIGN_FOR_EDUCATION = (
        21011,
        pgettext_lazy("CRSChannelCode", "Global Campaign for Education"),
    )
    HEALTH_ACTION_INTERNATIONAL = (
        21013,
        pgettext_lazy("CRSChannelCode", "Health Action International"),
    )
    ...
    INTERNATIONAL_CATHOLIC_RURAL_ASSOCIATION = (
        21015,
        pgettext_lazy("CRSChannelCode", "International Catholic Rural Association"),
    )
    INTERNATIONAL_COMMITTEE_OF_THE_RED_CROSS = (
        21016,
        pgettext_lazy("CRSChannelCode", "International Committee of the Red Cross"),
    )
    ...
    INTERNATIONAL_HIV_AIDS_ALLIANCE = (
        21020,
        pgettext_lazy("CRSChannelCode", "International HIV/AIDS Alliance"),
    )
    ...
    INTERNATIONAL_SEISMOLOGICAL_CENTRE = (
        21025,
        pgettext_lazy("CRSChannelCode", "International Seismological Centre"),
    )
    INTERNATIONAL_SERVICE_FOR_HUMAN_RIGHTS = (
        21026,
        pgettext_lazy("CRSChannelCode", "International Service for Human Rights"),
    )
    ITF_ENHANCING_HUMAN_SECURITY = (
        21027,
        pgettext_lazy("CRSChannelCode", "ITF Enhancing Human Security"),
    )
    ...
    DOCTORS_WITHOUT_BORDERS = (
        21029,
        pgettext_lazy("CRSChannelCode", "Doctors Without Borders"),
    )
    PAN_AFRICAN_INSTITUTE_FOR_DEVELOPMENT = (
        21030,
        pgettext_lazy("CRSChannelCode", "Pan African Institute for Development"),
    )
    PANOS_INSTITUTE = (
        21031,
        pgettext_lazy("CRSChannelCode", "PANOS Institute"),
    )
    POPULATION_SERVICES_INTERNATIONAL = (
        21032,
        pgettext_lazy("CRSChannelCode", "Population Services International"),
    )
    TRANSPARENCY_INTERNATIONAL = (
        21033,
        pgettext_lazy("CRSChannelCode", "Transparency International"),
    )
    ...
    WORLD_ORGANISATION_AGAINST_TORTURE = (
        21035,
        pgettext_lazy("CRSChannelCode", "World Organisation Against Torture"),
    )
    WORLD_UNIVERSITY_SERVICE = (
        21036,
        pgettext_lazy("CRSChannelCode", "World University Service"),
    )
    WOMEN_S_WORLD_BANKING = (
        21037,
        pgettext_lazy("CRSChannelCode", "Women's World Banking"),
    )
    INTERNATIONAL_ALERT = (
        21038,
        pgettext_lazy("CRSChannelCode", "International Alert"),
    )
    ...
    INTERNATIONAL_WOMEN_S_TRIBUNE_CENTRE = (
        21040,
        pgettext_lazy("CRSChannelCode", "International Women's Tribune Centre"),
    )
    SOCIETY_FOR_INTERNATIONAL_DEVELOPMENT = (
        21041,
        pgettext_lazy("CRSChannelCode", "Society for International Development"),
    )
    INTERNATIONAL_PEACEBUILDING_ALLIANCE = (
        21042,
        pgettext_lazy("CRSChannelCode", "International Peacebuilding Alliance"),
    )
    EUROPEAN_PARLIAMENTARIANS_FOR_AFRICA = (
        21043,
        pgettext_lazy("CRSChannelCode", "European Parliamentarians for Africa"),
    )
    ...
    AFRICAN_MEDICAL_AND_RESEARCH_FOUNDATION = (
        21045,
        pgettext_lazy("CRSChannelCode", "African Medical and Research Foundation"),
    )
    ...
    AGRICORD = (
        21047,
        pgettext_lazy("CRSChannelCode", "AgriCord"),
    )
    ASSOCIATION_OF_AFRICAN_UNIVERSITIES = (
        21048,
        pgettext_lazy("CRSChannelCode", "Association of African Universities"),
    )
    ...
    GENEVA_CALL = (
        21050,
        pgettext_lazy("CRSChannelCode", "Geneva Call"),
    )
    ...
    LIFE_AND_PEACE_INSTITUTE = (
        21054,
        pgettext_lazy("CRSChannelCode", "Life and Peace Institute"),
    )
    REGIONAL_AIDS_TRAINING_NETWORK = (
        21055,
        pgettext_lazy("CRSChannelCode", "Regional AIDS Training Network"),
    )
    ...
    INTERNATIONAL_CRISIS_GROUP = (
        21058,
        pgettext_lazy("CRSChannelCode", "International Crisis Group"),
    )
    AFRICA_SOLIDARITY_FUND = (
        21059,
        pgettext_lazy("CRSChannelCode", "Africa Solidarity Fund"),
    )
    ASSOCIATION_FOR_THE_PREVENTION_OF_TORTURE = (
        21060,
        pgettext_lazy("CRSChannelCode", "Association for the Prevention of Torture"),
    )
    ...
    THE_NATURE_CONSERVANCY = (
        21062,
        pgettext_lazy("CRSChannelCode", "The Nature Conservancy"),
    )
    CONSERVATION_INTERNATIONAL = (
        21063,
        pgettext_lazy("CRSChannelCode", "Conservation International"),
    )
    CLINTON_HEALTH_ACCESS_INITIATIVE__INC_ = (
        21064,
        pgettext_lazy("CRSChannelCode", "Clinton Health Access Initiative, Inc."),
    )
    OXFAM_INTERNATIONAL = (
        21501,
        pgettext_lazy("CRSChannelCode", "OXFAM International"),
    )
    WORLD_VISION = (
        21502,
        pgettext_lazy("CRSChannelCode", "World Vision"),
    )
    FAMILY_HEALTH_INTERNATIONAL_360 = (
        21503,
        pgettext_lazy("CRSChannelCode", "Family Health International 360"),
    )
    INTERNATIONAL_RELIEF_AND_DEVELOPMENT = (
        21504,
        pgettext_lazy("CRSChannelCode", "International Relief and Development"),
    )
    SAVE_THE_CHILDREN = (
        21505,
        pgettext_lazy("CRSChannelCode", "Save the Children"),
    )
    INTERNATIONAL_RESCUE_COMMITTEE = (
        21506,
        pgettext_lazy("CRSChannelCode", "International Rescue Committee"),
    )
    PACT_WORLD = (
        21507,
        pgettext_lazy("CRSChannelCode", "Pact World"),
    )
    DONOR_COUNTRY_BASED_NGO = (
        22000,
        pgettext_lazy("CRSChannelCode", "Donor country-based NGO"),
    )
    OXFAM_PROVIDER_COUNTRY_OFFICE = (
        22501,
        pgettext_lazy("CRSChannelCode", "OXFAM - provider country office"),
    )
    SAVE_THE_CHILDREN_DONOR_COUNTRY_OFFICE = (
        22502,
        pgettext_lazy("CRSChannelCode", "Save the Children - donor country office"),
    )
    DEVELOPING_COUNTRY_BASED_NGO = (
        23000,
        pgettext_lazy("CRSChannelCode", "Developing country-based NGO"),
    )
    ...
    GLOBAL_ALLIANCE_FOR_IMPROVED_NUTRITION = (
        30001,
        pgettext_lazy("CRSChannelCode", "Global Alliance for Improved Nutrition"),
    )
    ...
    GLOBAL_WATER_PARTNERSHIP = (
        30004,
        pgettext_lazy("CRSChannelCode", "Global Water Partnership"),
    )
    INTERNATIONAL_AIDS_VACCINE_INITIATIVE = (
        30005,
        pgettext_lazy("CRSChannelCode", "International AIDS Vaccine Initiative"),
    )
    INTERNATIONAL_PARTNERSHIP_ON_MICROBICIDES = (
        30006,
        pgettext_lazy("CRSChannelCode", "International Partnership on Microbicides"),
    )
    GLOBAL_ALLIANCE_FOR_ICT_AND_DEVELOPMENT = (
        30007,
        pgettext_lazy("CRSChannelCode", "Global Alliance for ICT and Development"),
    )
    CITIES_ALLIANCE = (
        30008,
        pgettext_lazy("CRSChannelCode", "Cities Alliance"),
    )
    SMALL_ARMS_SURVEY = (
        30009,
        pgettext_lazy("CRSChannelCode", "Small Arms Survey"),
    )
    INTERNATIONAL_DRUG_PURCHASE_FACILITY = (
        30010,
        pgettext_lazy("CRSChannelCode", "International drug purchase facility"),
    )
    ...
    GLOBAL_CLIMATE_PARTNERSHIP_FUND = (
        30012,
        pgettext_lazy("CRSChannelCode", "Global Climate Partnership Fund"),
    )
    MICROFINANCE_ENHANCEMENT_FACILITY = (
        30013,
        pgettext_lazy("CRSChannelCode", "Microfinance Enhancement Facility"),
    )
    ...
    EUROPEAN_FUND_FOR_SOUTHEAST_EUROPE = (
        30016,
        pgettext_lazy("CRSChannelCode", "European Fund for Southeast Europe"),
    )
    ...
    PUBLIC_PRIVATE_PARTNERSHIPS__PPP_ = (
        31000,
        pgettext_lazy("CRSChannelCode", "Public-Private Partnerships (PPP)"),
    )
    GLOBAL_DEVELOPMENT_NETWORK = (
        31001,
        pgettext_lazy("CRSChannelCode", "Global Development Network"),
    )
    GLOBAL_KNOWLEDGE_PARTNERSHIP = (
        31002,
        pgettext_lazy("CRSChannelCode", "Global Knowledge Partnership"),
    )
    INTERNATIONAL_LAND_COALITION = (
        31003,
        pgettext_lazy("CRSChannelCode", "International Land Coalition"),
    )
    ...
    PARLIAMENTARY_NETWORK_ON_THE_WORLD_BANK = (
        31005,
        pgettext_lazy("CRSChannelCode", "Parliamentary Network on the World Bank"),
    )
    ...
    NETWORKS = (
        32000,
        pgettext_lazy("CRSChannelCode", "Networks"),
    )
    MULTILATERAL_ORGANISATIONS = (
        40000,
        pgettext_lazy("CRSChannelCode", "Multilateral Organisations"),
    )
    ...
    CONVENTION_TO_COMBAT_DESERTIFICATION = (
        41101,
        pgettext_lazy("CRSChannelCode", "Convention to Combat Desertification"),
    )
    ...
    ECONOMIC_COMMISSION_FOR_AFRICA = (
        41103,
        pgettext_lazy("CRSChannelCode", "Economic Commission for Africa"),
    )
    ...
    JOINT_UNITED_NATIONS_PROGRAMME_ON_HIV_AIDS = (
        41110,
        pgettext_lazy("CRSChannelCode", "Joint United Nations Programme on HIV/AIDS"),
    )
    UNITED_NATIONS_CAPITAL_DEVELOPMENT_FUND = (
        41111,
        pgettext_lazy("CRSChannelCode", "United Nations Capital Development Fund"),
    )
    ...
    UNITED_NATIONS_DEVELOPMENT_PROGRAMME = (
        41114,
        pgettext_lazy("CRSChannelCode", "United Nations Development Programme"),
    )
    UNITED_NATIONS_ENVIRONMENT_PROGRAMME = (
        41116,
        pgettext_lazy("CRSChannelCode", "United Nations Environment Programme"),
    )
    UNITED_NATIONS_POPULATION_FUND = (
        41119,
        pgettext_lazy("CRSChannelCode", "United Nations Population Fund"),
    )
    UNITED_NATIONS_HUMAN_SETTLEMENT_PROGRAMME = (
        41120,
        pgettext_lazy("CRSChannelCode", "United Nations Human Settlement Programme"),
    )
    ...
    UNITED_NATIONS_CHILDREN_S_FUND = (
        41122,
        pgettext_lazy("CRSChannelCode", "United Nations Children’s Fund"),
    )
    ...
    UNITED_NATIONS_DEVELOPMENT_FUND_FOR_WOMEN = (
        41124,
        pgettext_lazy("CRSChannelCode", "United Nations Development Fund for Women"),
    )
    ...
    UNITED_NATIONS_MINE_ACTION_SERVICE = (
        41126,
        pgettext_lazy("CRSChannelCode", "United Nations Mine Action Service"),
    )
    ...
    UNITED_NATIONS_OFFICE_ON_DRUGS_AND_CRIME = (
        41128,
        pgettext_lazy("CRSChannelCode", "United Nations Office on Drugs and Crime"),
    )
    ...
    UNITED_NATIONS_SYSTEM_STAFF_COLLEGE = (
        41131,
        pgettext_lazy("CRSChannelCode", "United Nations System Staff College"),
    )
    ...
    UNITED_NATIONS_VOLUNTEERS = (
        41135,
        pgettext_lazy("CRSChannelCode", "United Nations Volunteers"),
    )
    ...
    WORLD_FOOD_PROGRAMME = (
        41140,
        pgettext_lazy("CRSChannelCode", "World Food Programme"),
    )
    ...
    UNITED_NATIONS_DEMOCRACY_FUND = (
        41142,
        pgettext_lazy("CRSChannelCode", "United Nations Democracy Fund"),
    )
    ...
    CENTRAL_EMERGENCY_RESPONSE_FUND = (
        41147,
        pgettext_lazy("CRSChannelCode", "Central Emergency Response Fund"),
    )
    ...
    FOOD_AND_AGRICULTURAL_ORGANISATION = (
        41301,
        pgettext_lazy("CRSChannelCode", "Food and Agricultural Organisation"),
    )
    ...
    INTERNATIONAL_TELECOMMUNICATIONS_UNION = (
        41303,
        pgettext_lazy("CRSChannelCode", "International Telecommunications Union"),
    )
    ...
    UNITED_NATIONS = (
        41305,
        pgettext_lazy("CRSChannelCode", "United Nations"),
    )
    UNIVERSAL_POSTAL_UNION = (
        41306,
        pgettext_lazy("CRSChannelCode", "Universal Postal Union"),
    )
    ...
    WORLD_INTELLECTUAL_PROPERTY_ORGANISATION = (
        41308,
        pgettext_lazy("CRSChannelCode", "World Intellectual Property Organisation"),
    )
    WORLD_METEOROLOGICAL_ORGANISATION = (
        41309,
        pgettext_lazy("CRSChannelCode", "World Meteorological Organisation"),
    )
    ...
    GREEN_CLIMATE_FUND = (
        41317,
        pgettext_lazy("CRSChannelCode", "Green Climate Fund"),
    )
    GLOBAL_MECHANISM = (
        41318,
        pgettext_lazy("CRSChannelCode", "Global Mechanism"),
    )
    WORLD_TOURISM_ORGANIZATION = (
        41319,
        pgettext_lazy("CRSChannelCode", "World Tourism Organization"),
    )
    ...
    UNITED_NATIONS_OFFICE_FOR_PROJECT_SERVICES = (
        41502,
        pgettext_lazy("CRSChannelCode", "United Nations Office for Project Services"),
    )
    UN_LED_COUNTRY_BASED_POOLED_FUNDS = (
        41503,
        pgettext_lazy("CRSChannelCode", "UN-led Country-based Pooled Funds"),
    )
    EUROPEAN_UNION_INSTITUTIONS = (
        42000,
        pgettext_lazy("CRSChannelCode", "European Union Institutions"),
    )
    ...
    EUROPEAN_INVESTMENT_BANK = (
        42004,
        pgettext_lazy("CRSChannelCode", "European Investment Bank"),
    )
    ...
    INTERNATIONAL_MONETARY_FUND__IMF_ = (
        43000,
        pgettext_lazy("CRSChannelCode", "International Monetary Fund (IMF)"),
    )
    ...
    CATASTROPHE_CONTAINMENT_AND_RELIEF_TRUST = (
        43006,
        pgettext_lazy("CRSChannelCode", "Catastrophe Containment and Relief Trust"),
    )
    WORLD_BANK_GROUP__WB_ = (
        44000,
        pgettext_lazy("CRSChannelCode", "World Bank Group (WB)"),
    )
    ...
    INTERNATIONAL_DEVELOPMENT_ASSOCIATION = (
        44002,
        pgettext_lazy("CRSChannelCode", "International Development Association"),
    )
    ...
    INTERNATIONAL_FINANCE_CORPORATION = (
        44004,
        pgettext_lazy("CRSChannelCode", "International Finance Corporation"),
    )
    MULTILATERAL_INVESTMENT_GUARANTEE_AGENCY = (
        44005,
        pgettext_lazy("CRSChannelCode", "Multilateral Investment Guarantee Agency"),
    )
    ADVANCE_MARKET_COMMITMENTS = (
        44006,
        pgettext_lazy("CRSChannelCode", "Advance Market Commitments"),
    )
    ...
    WORLD_TRADE_ORGANISATION__WTO_ = (
        45000,
        pgettext_lazy("CRSChannelCode", "World Trade Organisation (WTO)"),
    )
    ...
    REGIONAL_DEVELOPMENT_BANKS = (
        46000,
        pgettext_lazy("CRSChannelCode", "Regional Development Banks"),
    )
    AFRICAN_DEVELOPMENT_BANK = (
        46002,
        pgettext_lazy("CRSChannelCode", "African Development Bank"),
    )
    AFRICAN_DEVELOPMENT_FUND = (
        46003,
        pgettext_lazy("CRSChannelCode", "African Development Fund"),
    )
    ASIAN_DEVELOPMENT_BANK = (
        46004,
        pgettext_lazy("CRSChannelCode", "Asian Development Bank"),
    )
    ASIAN_DEVELOPMENT_FUND = (
        46005,
        pgettext_lazy("CRSChannelCode", "Asian Development Fund"),
    )
    BLACK_SEA_TRADE_AND_DEVELOPMENT_BANK = (
        46006,
        pgettext_lazy("CRSChannelCode", "Black Sea Trade and Development Bank"),
    )
    ...
    DEVELOPMENT_BANK_OF_LATIN_AMERICA = (
        46008,
        pgettext_lazy("CRSChannelCode", "Development Bank of Latin America"),
    )
    CARIBBEAN_DEVELOPMENT_BANK = (
        46009,
        pgettext_lazy("CRSChannelCode", "Caribbean Development Bank"),
    )
    ...
    CENTRAL_AFRICAN_STATES_DEVELOPMENT_BANK = (
        46020,
        pgettext_lazy("CRSChannelCode", "Central African States Development Bank"),
    )
    WEST_AFRICAN_DEVELOPMENT_BANK = (
        46021,
        pgettext_lazy("CRSChannelCode", "West African Development Bank"),
    )
    AFRICAN_EXPORT_IMPORT_BANK = (
        46022,
        pgettext_lazy("CRSChannelCode", "African Export Import Bank"),
    )
    ...
    COUNCIL_OF_EUROPE_DEVELOPMENT_BANK = (
        46024,
        pgettext_lazy("CRSChannelCode", "Council of Europe Development Bank"),
    )
    ISLAMIC_DEVELOPMENT_BANK = (
        46025,
        pgettext_lazy("CRSChannelCode", "Islamic Development Bank"),
    )
    ASIAN_INFRASTRUCTURE_INVESTMENT_BANK = (
        46026,
        pgettext_lazy("CRSChannelCode", "Asian Infrastructure Investment Bank"),
    )
    ...
    OTHER_MULTILATERAL_INSTITUTIONS = (
        47000,
        pgettext_lazy("CRSChannelCode", "Other multilateral institutions"),
    )
    AFRICAN_CAPACITY_BUILDING_FOUNDATION = (
        47001,
        pgettext_lazy("CRSChannelCode", "African Capacity Building Foundation"),
    )
    ASIAN_PRODUCTIVITY_ORGANISATION = (
        47002,
        pgettext_lazy("CRSChannelCode", "Asian Productivity Organisation"),
    )
    ...
    ASEAN_CULTURAL_FUND = (
        47004,
        pgettext_lazy("CRSChannelCode", "ASEAN Cultural Fund"),
    )
    ...
    WORLD_VEGETABLE_CENTRE = (
        47008,
        pgettext_lazy("CRSChannelCode", "World Vegetable Centre"),
    )
    ...
    CARIBBEAN_COMMUNITY_SECRETARIAT = (
        47011,
        pgettext_lazy("CRSChannelCode", "Caribbean Community Secretariat"),
    )
    CARIBBEAN_EPIDEMIOLOGY_CENTRE = (
        47012,
        pgettext_lazy("CRSChannelCode", "Caribbean Epidemiology Centre"),
    )
    COMMONWEALTH_FOUNDATION = (
        47013,
        pgettext_lazy("CRSChannelCode", "Commonwealth Foundation"),
    )
    ...
    CGIAR_FUND = (
        47015,
        pgettext_lazy("CRSChannelCode", "CGIAR Fund"),
    )
    COMMONWEALTH_INSTITUTE = (
        47016,
        pgettext_lazy("CRSChannelCode", "Commonwealth Institute"),
    )
    ...
    CENTRE_FOR_INTERNATIONAL_FORESTRY_RESEARCH = (
        47018,
        pgettext_lazy("CRSChannelCode", "Centre for International Forestry Research"),
    )
    ...
    INTERNATIONAL_POTATO_CENTRE = (
        47021,
        pgettext_lazy("CRSChannelCode", "International Potato Centre"),
    )
    ...
    COMMONWEALTH_LEGAL_ADVISORY_SERVICE = (
        47023,
        pgettext_lazy("CRSChannelCode", "Commonwealth Legal Advisory Service"),
    )
    COMMONWEALTH_MEDIA_DEVELOPMENT_FUND = (
        47024,
        pgettext_lazy("CRSChannelCode", "Commonwealth Media Development Fund"),
    )
    COMMONWEALTH_OF_LEARNING = (
        47025,
        pgettext_lazy("CRSChannelCode", "Commonwealth of Learning"),
    )
    COMMUNITY_OF_PORTUGUESE_SPEAKING_COUNTRIES = (
        47026,
        pgettext_lazy("CRSChannelCode", "Community of Portuguese Speaking Countries"),
    )
    COLOMBO_PLAN = (
        47027,
        pgettext_lazy("CRSChannelCode", "Colombo Plan"),
    )
    ...
    SAHEL_AND_WEST_AFRICA_CLUB = (
        47029,
        pgettext_lazy("CRSChannelCode", "Sahel and West Africa Club"),
    )
    COMMONWEALTH_SCIENTIFIC_COUNCIL = (
        47030,
        pgettext_lazy("CRSChannelCode", "Commonwealth Scientific Council"),
    )
    COMMONWEALTH_SMALL_STATES_OFFICE = (
        47031,
        pgettext_lazy("CRSChannelCode", "Commonwealth Small States Office"),
    )
    ...
    COMMONWEALTH_YOUTH_PROGRAMME = (
        47033,
        pgettext_lazy("CRSChannelCode", "Commonwealth Youth Programme"),
    )
    ECONOMIC_COMMUNITY_OF_WEST_AFRICAN_STATES = (
        47034,
        pgettext_lazy("CRSChannelCode", "Economic Community of West African States"),
    )
    ...
    FORUM_FISHERIES_AGENCY = (
        47040,
        pgettext_lazy("CRSChannelCode", "Forum Fisheries Agency"),
    )
    FOOD_AND_FERTILIZER_TECHNOLOGY_CENTRE = (
        47041,
        pgettext_lazy("CRSChannelCode", "Food and Fertilizer Technology Centre"),
    )
    FOUNDATION_FOR_INTERNATIONAL_TRAINING = (
        47042,
        pgettext_lazy("CRSChannelCode", "Foundation for International Training"),
    )
    GLOBAL_CROP_DIVERSITY_TRUST = (
        47043,
        pgettext_lazy("CRSChannelCode", "Global Crop Diversity Trust"),
    )
    GLOBAL_ENVIRONMENT_FACILITY_TRUST_FUND = (
        47044,
        pgettext_lazy("CRSChannelCode", "Global Environment Facility Trust Fund"),
    )
    ...
    INTERNATIONAL_AFRICAN_INSTITUTE = (
        47047,
        pgettext_lazy("CRSChannelCode", "International African Institute"),
    )
    INTER_AMERICAN_INDIAN_INSTITUTE = (
        47048,
        pgettext_lazy("CRSChannelCode", "Inter-American Indian Institute"),
    )
    ...
    INTERNATIONAL_COTTON_ADVISORY_COMMITTEE = (
        47050,
        pgettext_lazy("CRSChannelCode", "International Cotton Advisory Committee"),
    )
    ...
    WORLD_AGROFORESTRY_CENTRE = (
        47056,
        pgettext_lazy("CRSChannelCode", "World AgroForestry Centre"),
    )
    ...
    INTERNATIONAL_DEVELOPMENT_LAW_ORGANISATION = (
        47059,
        pgettext_lazy("CRSChannelCode", "International Development Law Organisation"),
    )
    INTERNATIONAL_INSTITUTE_FOR_COTTON = (
        47060,
        pgettext_lazy("CRSChannelCode", "International Institute for Cotton"),
    )
    ...
    INTERNATIONAL_LIVESTOCK_RESEARCH_INSTITUTE = (
        47063,
        pgettext_lazy("CRSChannelCode", "International Livestock Research Institute"),
    )
    ...
    INTERGOVERNMENTAL_OCEANOGRAPHIC_COMMISSION = (
        47065,
        pgettext_lazy("CRSChannelCode", "Intergovernmental Oceanographic Commission"),
    )
    INTERNATIONAL_ORGANISATION_FOR_MIGRATION = (
        47066,
        pgettext_lazy("CRSChannelCode", "International Organisation for Migration"),
    )
    INTERGOVERNMENTAL_PANEL_ON_CLIMATE_CHANGE = (
        47067,
        pgettext_lazy("CRSChannelCode", "Intergovernmental Panel on Climate Change"),
    )
    ASIA_PACIFIC_FISHERY_COMMISSION = (
        47068,
        pgettext_lazy("CRSChannelCode", "Asia-Pacific Fishery Commission"),
    )
    BIOVERSITY_INTERNATIONAL = (
        47069,
        pgettext_lazy("CRSChannelCode", "Bioversity International"),
    )
    INTERNATIONAL_RICE_RESEARCH_INSTITUTE = (
        47070,
        pgettext_lazy("CRSChannelCode", "International Rice Research Institute"),
    )
    INTERNATIONAL_SEED_TESTING_ASSOCIATION = (
        47071,
        pgettext_lazy("CRSChannelCode", "International Seed Testing Association"),
    )
    INTERNATIONAL_TROPICAL_TIMBER_ORGANISATION = (
        47073,
        pgettext_lazy("CRSChannelCode", "International Tropical Timber Organisation"),
    )
    INTERNATIONAL_VACCINE_INSTITUTE = (
        47074,
        pgettext_lazy("CRSChannelCode", "International Vaccine Institute"),
    )
    INTERNATIONAL_WATER_MANAGEMENT_INSTITUTE = (
        47075,
        pgettext_lazy("CRSChannelCode", "International Water Management Institute"),
    )
    JUSTICE_STUDIES_CENTRE_OF_THE_AMERICAS = (
        47076,
        pgettext_lazy("CRSChannelCode", "Justice Studies Centre of the Americas"),
    )
    MEKONG_RIVER_COMMISSION = (
        47077,
        pgettext_lazy("CRSChannelCode", "Mekong River Commission"),
    )
    ...
    ORGANISATION_OF_AMERICAN_STATES = (
        47079,
        pgettext_lazy("CRSChannelCode", "Organisation of American States"),
    )
    ...
    OECD_DEVELOPMENT_CENTRE = (
        47081,
        pgettext_lazy("CRSChannelCode", "OECD Development Centre"),
    )
    ORGANISATION_OF_EASTERN_CARIBBEAN_STATES = (
        47082,
        pgettext_lazy("CRSChannelCode", "Organisation of Eastern Caribbean States"),
    )
    PAN_AMERICAN_HEALTH_ORGANISATION = (
        47083,
        pgettext_lazy("CRSChannelCode", "Pan-American Health Organisation"),
    )
    ...
    PAN_AMERICAN_RAILWAY_CONGRESS_ASSOCIATION = (
        47085,
        pgettext_lazy("CRSChannelCode", "Pan-American Railway Congress Association"),
    )
    PRIVATE_INFRASTRUCTURE_DEVELOPMENT_GROUP = (
        47086,
        pgettext_lazy("CRSChannelCode", "Private Infrastructure Development Group"),
    )
    PACIFIC_ISLANDS_FORUM_SECRETARIAT = (
        47087,
        pgettext_lazy("CRSChannelCode", "Pacific Islands Forum Secretariat"),
    )
    RELIEF_NET = (
        47088,
        pgettext_lazy("CRSChannelCode", "Relief Net"),
    )
    SOUTHERN_AFRICAN_DEVELOPMENT_COMMUNITY = (
        47089,
        pgettext_lazy("CRSChannelCode", "Southern African Development Community"),
    )
    ...
    SOUTH_EAST_ASIAN_MINISTERS_OF_EDUCATION = (
        47093,
        pgettext_lazy("CRSChannelCode", "South East Asian Ministers of Education"),
    )
    ...
    SECRETARIAT_OF_THE_PACIFIC_COMMUNITY = (
        47096,
        pgettext_lazy("CRSChannelCode", "Secretariat of the Pacific Community"),
    )
    PACIFIC_REGIONAL_ENVIRONMENT_PROGRAMME = (
        47097,
        pgettext_lazy("CRSChannelCode", "Pacific Regional Environment Programme"),
    )
    ...
    UNIVERSITY_OF_THE_SOUTH_PACIFIC = (
        47099,
        pgettext_lazy("CRSChannelCode", "University of the South Pacific"),
    )
    WEST_AFRICAN_MONETARY_UNION = (
        47100,
        pgettext_lazy("CRSChannelCode", "West African Monetary Union"),
    )
    AFRICA_RICE_CENTRE = (
        47101,
        pgettext_lazy("CRSChannelCode", "Africa Rice Centre"),
    )
    ...
    WORLD_MARITIME_UNIVERSITY = (
        47103,
        pgettext_lazy("CRSChannelCode", "World Maritime University"),
    )
    WORLDFISH_CENTRE = (
        47104,
        pgettext_lazy("CRSChannelCode", "WorldFish Centre"),
    )
    COMMON_FUND_FOR_COMMODITIES = (
        47105,
        pgettext_lazy("CRSChannelCode", "Common Fund for Commodities"),
    )
    ...
    ADAPTATION_FUND = (
        47111,
        pgettext_lazy("CRSChannelCode", "Adaptation Fund"),
    )
    ...
    NEW_PARTNERSHIP_FOR_AFRICA_S_DEVELOPMENT = (
        47117,
        pgettext_lazy("CRSChannelCode", "New Partnership for Africa's Development"),
    )
    ...
    SAHARA_AND_SAHEL_OBSERVATORY = (
        47119,
        pgettext_lazy("CRSChannelCode", "Sahara and Sahel Observatory"),
    )
    ...
    LATIN_AMERICAN_ENERGY_ORGANISATION = (
        47127,
        pgettext_lazy("CRSChannelCode", "Latin-American Energy Organisation"),
    )
    NORDIC_DEVELOPMENT_FUND = (
        47128,
        pgettext_lazy("CRSChannelCode", "Nordic Development Fund"),
    )
    ...
    CLEAN_TECHNOLOGY_FUND = (
        47134,
        pgettext_lazy("CRSChannelCode", "Clean Technology Fund"),
    )
    STRATEGIC_CLIMATE_FUND = (
        47135,
        pgettext_lazy("CRSChannelCode", "Strategic Climate Fund"),
    )
    GLOBAL_GREEN_GROWTH_INSTITUTE = (
        47136,
        pgettext_lazy("CRSChannelCode", "Global Green Growth Institute"),
    )
    AFRICAN_RISK_CAPACITY_GROUP = (
        47137,
        pgettext_lazy("CRSChannelCode", "African Risk Capacity Group"),
    )
    COUNCIL_OF_EUROPE = (
        47138,
        pgettext_lazy("CRSChannelCode", "Council of Europe"),
    )
    ...
    AFRICAN_TAX_ADMINISTRATION_FORUM = (
        47141,
        pgettext_lazy("CRSChannelCode", "African Tax Administration Forum"),
    )
    OPEC_FUND_FOR_INTERNATIONAL_DEVELOPMENT = (
        47142,
        pgettext_lazy("CRSChannelCode", "OPEC Fund for International Development"),
    )
    ...
    INTERNATIONAL_RENEWABLE_ENERGY_AGENCY = (
        47144,
        pgettext_lazy("CRSChannelCode", "International Renewable Energy Agency"),
    )
    CENTER_OF_EXCELLENCE_IN_FINANCE = (
        47145,
        pgettext_lazy("CRSChannelCode", "Center of Excellence in Finance"),
    )
    INTERNATIONAL_INVESTMENT_BANK = (
        47146,
        pgettext_lazy("CRSChannelCode", "International Investment Bank"),
    )
    ...
    WORLD_ORGANISATION_FOR_ANIMAL_HEALTH = (
        47148,
        pgettext_lazy("CRSChannelCode", "World Organisation for Animal Health"),
    )
    ...
    GLOBAL_PARTNERSHIP_FOR_EDUCATION = (
        47501,
        pgettext_lazy("CRSChannelCode", "Global Partnership for Education"),
    )
    GLOBAL_FUND_FOR_DISASTER_RISK_REDUCTION = (
        47502,
        pgettext_lazy("CRSChannelCode", "Global Fund for Disaster Risk Reduction"),
    )
    ...
    FOREST_CARBON_PARTNERSHIP_FACILITY = (
        47504,
        pgettext_lazy("CRSChannelCode", "Forest Carbon Partnership Facility"),
    )
    OTHERS = (
        50000,
        pgettext_lazy("CRSChannelCode", "Others"),
    )
    ...
    OTHER = (
        52000,
        pgettext_lazy("CRSChannelCode", "Other"),
    )
    PRIVATE_SECTOR_INSTITUTIONS = (
        60000,
        pgettext_lazy("CRSChannelCode", "Private Sector Institutions"),
    )
    PRIVATE_SECTOR_IN_PROVIDER_COUNTRY = (
        61000,
        pgettext_lazy("CRSChannelCode", "Private sector in provider country"),
    )
    BANKS__DEPOSIT_TAKING_CORPORATIONS_ = (
        61001,
        pgettext_lazy("CRSChannelCode", "Banks (deposit taking corporations)"),
    )
    PRIVATE_EXPORTER_IN_PROVIDER_COUNTRY = (
        61002,
        pgettext_lazy("CRSChannelCode", "Private exporter in provider country"),
    )
    ...
    INSURANCE_CORPORATIONS = (
        61005,
        pgettext_lazy("CRSChannelCode", "Insurance Corporations"),
    )
    PENSION_FUNDS = (
        61006,
        pgettext_lazy("CRSChannelCode", "Pension Funds"),
    )
    OTHER_FINANCIAL_CORPORATIONS = (
        61007,
        pgettext_lazy("CRSChannelCode", "Other financial corporations"),
    )
    EXPORTERS = (
        61008,
        pgettext_lazy("CRSChannelCode", "Exporters"),
    )
    OTHER_NON_FINANCIAL_CORPORATIONS = (
        61009,
        pgettext_lazy("CRSChannelCode", "Other non-financial corporations"),
    )
    RETAIL_INVESTORS = (
        61010,
        pgettext_lazy("CRSChannelCode", "Retail investors"),
    )
    PRIVATE_SECTOR_IN_RECIPIENT_COUNTRY = (
        62000,
        pgettext_lazy("CRSChannelCode", "Private sector in recipient country"),
    )
    ...
    IMPORTERS_EXPORTERS = (
        62008,
        pgettext_lazy("CRSChannelCode", "Importers/Exporters"),
    )
    OTHER_NON_FINANCIAL_CORPORATIONS = (
        62009,
        pgettext_lazy("CRSChannelCode", "Other non-financial corporations"),
    ...
    PRIVATE_SECTOR_IN_THIRD_COUNTRY = (
        63000,
        pgettext_lazy("CRSChannelCode", "Private sector in third country"),
    )
    BANKS__DEPOSIT_TAKING_CORPORATIONS_EXCEPT_MICRO_FINANCE_INSTITUTIONS_ = (
        63001,
        pgettext_lazy(
