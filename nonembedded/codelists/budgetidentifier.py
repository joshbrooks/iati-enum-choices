...
class BudgetIdentifier(models.TextChoices):
    ...
    EXECUTIVE_EXECUTIVE = (
        "1.1.1",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Executive - executive"),
    )
    LEGISLATIVE_LEGISLATIVE = (
        "1.2.1",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Legislative - legislative"),
    )
    ACCOUNTABILITY_MACROECONOMIC_POLICY = (
        "1.3.1",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Accountability - macroeconomic policy"
        ),
    )
    ACCOUNTABILITY_BUDGETING = (
        "1.3.2",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Accountability - budgeting"),
    )
    ACCOUNTABILITY_PLANNING = (
        "1.3.3",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Accountability - planning"),
    )
    ACCOUNTABILITY_TREASURY_ACCOUNTS = (
        "1.3.4",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Accountability - Treasury/Accounts"
        ),
    )
    ACCOUNTABILITY_DEBT_AND_AID_MANAGEMENT = (
        "1.3.5",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Accountability - debt and aid management"
        ),
    )
    ACCOUNTABILITY_TAX_POLICY = (
        "1.3.6",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Accountability - tax policy"),
    )
    ACCOUNTABILITY_TAX_COLLECTION = (
        "1.3.7",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Accountability - tax collection"
        ),
    )
    ACCOUNTABILITY_LOCAL_GOVERNMENT_FINANCE = (
        "1.3.8",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier",
    ...
    ACCOUNTABILITY_NATIONAL_AUDIT = (
        "1.3.10",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Accountability - national audit"
        ),
    )
    ...
    ACCOUNTABILITY_MONETARY_INSTITUTIONS = (
        "1.3.12",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Accountability - monetary institutions"
        ),
    )
    ...
    EXTERNAL_AFFAIRS_FOREIGN_AFFAIRS = (
        "1.4.1",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "External Affairs - foreign affairs "
        ),
    )
    EXTERNAL_AFFAIRS_DIPLOMATIC_MISSIONS = (
        "1.4.2",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "External Affairs - diplomatic missions"
        ),
    )
    ...
    STATISTICS_STATISTICS = (
        "1.6.1",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Statistics - statistics"),
    )
    ...
    ELECTIONS_ELECTIONS = (
        "1.8.1",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Elections - elections"),
    )
    ...
    JUSTICE__LAW_AND_ORDER_FIRE_OR_POLICE = (
        "2.1.2",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Justice, Law and Order - fire or police"
        ),
    )
    ...
    JUSTICE__LAW_AND_ORDER_OMBUDSMAN = (
        "2.1.4",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Justice, Law and Order - Ombudsman"
        ),
    )
    ...
    JUSTICE__LAW_AND_ORDER_IMMIGRATION = (
        "2.1.6",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Justice, Law and Order - immigration"
        ),
    )
    JUSTICE__LAW_AND_ORDER_ANTI_CORRUPTION = (
        "2.1.7",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Justice, Law and Order - anti corruption"
        ),
    )
    JUSTICE__LAW_AND_ORDER_PRISONS = (
        "2.1.8",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Justice, Law and Order - prisons"
        ),
    )
    JUSTICE__LAW_AND_ORDER_PEACE_BUILDING = (
        "2.1.9",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Justice, Law and Order - peace building"
        ),
    )
    JUSTICE__LAW_AND_ORDER_DEMOBILISATION = (
        "2.1.10",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Justice, Law and Order - demobilisation"
        ),
    )
    ...
    DEFENCE_MILITARY = (
        "2.2.2",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Defence - military"),
    )
    DEFENCE_CIVIL_DEFENCE = (
        "2.2.3",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Defence - civil defence"),
    )
    DEFENCE_FOREIGN_MILITARY_AID = (
        "2.2.4",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Defence - foreign military aid"
        ),
    )
    ...
    PUBLIC_WORKS_CONSTRUCTION_REGULATION = (
        "3.2.2",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Public Works - construction regulation"
        ),
    )
    PUBLIC_WORKS_MECHANICAL_SERVICES = (
        "3.2.3",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Public Works - mechanical services"
        ),
    )
    ...
    AGRICULTURE_IRRIGATION = (
        "3.3.2",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Agriculture - irrigation"),
    )
    AGRICULTURE_INPUTS = (
        "3.3.3",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Agriculture - inputs"),
    )
    AGRICULTURE_FOOD_CROP = (
        "3.3.4",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Agriculture - food crop"),
    )
    AGRICULTURE_INDUSTRIAL_CROP = (
        "3.3.5",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Agriculture - industrial crop"
        ),
    )
    AGRICULTURE_LIVESTOCK = (
        "3.3.6",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Agriculture - livestock"),
    )
    ...
    AGRICULTURE_RESEARCH = (
        "3.3.8",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Agriculture - research"),
    )
    AGRICULTURE_OTHER_SERVICES = (
        "3.3.9",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Agriculture - other services"),
    )
    ...
    FORESTRY_DEVELOPMENT_AND_SERVICES = (
        "3.4.2",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Forestry - development and services"
        ),
    )
    FORESTRY_EDUCATION_TRAINING = (
        "3.4.3",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Forestry - education/training"
        ),
    )
    FORESTRY_RESEARCH = (
        "3.4.4",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Forestry - research"),
    )
    ...
    FISHING_AND_HUNTING_RESEARCH = (
        "3.5.4",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Fishing and Hunting - research"
        ),
    )
    ...
    ENERGY_EDUCATION_AND_TRAINING = (
        "3.6.2",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Energy - education and training"
        ),
    )
    ENERGY_ENERGY_REGULATION = (
        "3.6.3",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Energy - energy regulation"),
    )
    ENERGY_ELECTRICITY_TRANSMISSION = (
        "3.6.4",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Energy - electricity transmission"
        ),
    )
    ENERGY_NUCLEAR = (
        "3.6.5",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Energy - nuclear"),
    )
    ENERGY_POWER_GENERATION = (
        "3.6.6",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Energy - power generation"),
    )
    ENERGY_GAS = (
        "3.6.7",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Energy - gas "),
    )
    ...
    TRANSPORT_TRANSPORT_REGULATION = (
        "3.8.2",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Transport - transport regulation"
        ),
    )
    TRANSPORT_FEEDER_ROAD_CONSTRUCTION = (
        "3.8.3",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Transport - feeder road construction"
        ),
    )
    TRANSPORT_FEEDER_ROAD_MAINTENANCE = (
        "3.8.4",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Transport - feeder road maintenance"
        ),
    )
    TRANSPORT_NATIONAL_ROAD_CONSTRUCTION = (
        "3.8.5",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Transport - national road construction"
        ),
    )
    TRANSPORT_NATIONAL_ROAD_MAINTENANCE = (
        "3.8.6",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Transport - national road maintenance"
        ),
    )
    TRANSPORT_RAIL = (
        "3.8.7",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Transport - rail"),
    )
    TRANSPORT_WATER = (
        "3.8.8",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Transport - water"),
    )
    TRANSPORT_AIR = (
        "3.8.9",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Transport - air"),
    )
    TRANSPORT_PIPELINE = (
        "3.8.10",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Transport - pipeline"),
    )
    TRANSPORT_STORAGE_AND_DISTRIBUTION = (
        "3.8.11",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Transport - storage and distribution"
        ),
    )
    TRANSPORT_PUBLIC_TRANSPORT_SERVICES = (
        "3.8.12",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Transport - public transport services"
        ),
    )
    TRANSPORT_METEOROLOGICAL_SERVICES = (
        "3.8.13",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Transport - meteorological services"
        ),
    )
    TRANSPORT_EDUCATION_AND_TRAINING = (
        "3.8.14",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Transport - education and training"
        ),
    )
    ...
    INDUSTRY_DEVELOPMENT_AND_SERVICES = (
        "3.9.2",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Industry - development and services"
        ),
    )
    INDUSTRY_INDUSTRIAL_RESEARCH = (
        "3.9.3",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Industry - industrial research"
        ),
    )
    INDUSTRY__INVESTMENT_IN_INDUSTRY_ = (
        "3.9.4",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Industry - (investment in industry)"
        ),
    )
    ...
    COMMUNICATIONS_ICT_INFRASTRUCTURE = (
        "3.10.2",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Communications - ICT Infrastructure"
        ),
    )
    ...
    COMMUNICATIONS_INFORMATION_SERVICES = (
        "3.10.4",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Communications - information services"
        ),
    )
    ...
    TOURISM_SERVICES = (
        "3.11.2",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Tourism - services"),
    )
    ...
    ENVIRONMENT_WATER_RESOURCES_MANAGEMENT = (
        "4.2.4",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Environment - water resources management"
        ),
    )
    ...
    EDUCATION_RESEARCH = (
        "5.3.2",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Education - research"),
    )
    EDUCATION_PRE_PRIMARY = (
        "5.3.3",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Education - pre-primary"),
    )
    EDUCATION_PRIMARY = (
        "5.3.4",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Education - primary"),
    )
    EDUCATION_LOWER_SECONDARY = (
        "5.3.5",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Education - lower secondary"),
    )
    EDUCATION_UPPER_SECONDARY = (
        "5.3.6",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Education - upper secondary"),
    )
    EDUCATION_POST_SECONDARY_NON_TERTIARY = (
        "5.3.7",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Education - post secondary non tertiary "
        ),
    )
    EDUCATION_TERTIARY = (
        "5.3.8",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Education - tertiary"),
    )
    EDUCATION_VOCATIONAL_TRAINING = (
        "5.3.9",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Education - vocational training"
        ),
    )
    ...
    EDUCATION_BASIC_ADULT_EDUCATION = (
        "5.3.11",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Education - basic adult education"
        ),
    )
    EDUCATION_TEACHER_TRAINING = (
        "5.3.12",
        pgettext_lazy("IATI codelist BudgetIdentifier", "Education - teacher training"),
    )
    EDUCATION_SUBSIDIARY_SERVICES = (
        "5.3.13",
        pgettext_lazy(
            "IATI codelist BudgetIdentifier", "Education - subsidiary services"
        ),
    )
