...
class SectorVocabulary(models.IntegerChoices):
    OECD_DAC_CRS_PURPOSE_CODES__5_DIGIT_ = (
        1,
        pgettext_lazy(
            "IATI codelist SectorVocabulary", "OECD DAC CRS Purpose Codes (5 digit)"
        ),
    )
    OECD_DAC_CRS_PURPOSE_CODES__3_DIGIT_ = (
        2,
        pgettext_lazy(
            "IATI codelist SectorVocabulary", "OECD DAC CRS Purpose Codes (3 digit)"
        ),
    )
    CLASSIFICATION_OF_THE_FUNCTIONS_OF_GOVERNMENT__UN_ = (
        3,
        pgettext_lazy(
            "IATI codelist SectorVocabulary",
    ...
    AIDDATA = (
        6,
        pgettext_lazy("IATI codelist SectorVocabulary", "AidData"),
    )
    SDG_GOAL = (
        7,
        pgettext_lazy("IATI codelist SectorVocabulary", "SDG Goal"),
    )
    SDG_TARGET = (
        8,
        pgettext_lazy("IATI codelist SectorVocabulary", "SDG Target"),
    )
    SDG_INDICATOR = (
        9,
        pgettext_lazy("IATI codelist SectorVocabulary", "SDG Indicator"),
    )
    ...
    REPORTING_ORGANISATION = (
        99,
        pgettext_lazy("IATI codelist SectorVocabulary", "Reporting Organisation"),
    )
    REPORTING_ORGANISATION_2 = (
        98,
        pgettext_lazy("IATI codelist SectorVocabulary", "Reporting Organisation 2"),
    )
