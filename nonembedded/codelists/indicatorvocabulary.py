...
class IndicatorVocabulary(models.IntegerChoices):
    ...
    WHO_REGISTRY = (
        1,
        pgettext_lazy("IATI codelist IndicatorVocabulary", "WHO Registry"),
    )
    SPHERE_HANDBOOK = (
        2,
        pgettext_lazy("IATI codelist IndicatorVocabulary", "Sphere Handbook"),
    )
    US_FOREIGN_ASSISTANCE_FRAMEWORK = (
        3,
        pgettext_lazy(
            "IATI codelist IndicatorVocabulary", "US Foreign Assistance Framework"
        ),
    )
    WORLD_BANK_WORLD_DEVELOPMENT_INDICATORS = (
        4,
        pgettext_lazy(
            "IATI codelist IndicatorVocabulary",
    ...
    HIV_AIDS_INDICATOR_REGISTRY = (
        7,
        pgettext_lazy(
            "IATI codelist IndicatorVocabulary", "HIV/AIDS Indicator Registry"
        ),
    )
    ...
    REPORTING_ORGANISATION = (
        99,
        pgettext_lazy("IATI codelist IndicatorVocabulary", "Reporting Organisation"),
    )
