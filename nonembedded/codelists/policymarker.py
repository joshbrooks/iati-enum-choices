...
class PolicyMarker(models.IntegerChoices):
    ...
    GENDER_EQUALITY = (
        1,
        pgettext_lazy("IATI codelist PolicyMarker", "Gender Equality"),
    )
    AID_TO_ENVIRONMENT = (
        2,
        pgettext_lazy("IATI codelist PolicyMarker", "Aid to Environment"),
    )
    PARTICIPATORY_DEVELOPMENT_GOOD_GOVERNANCE = (
        3,
        pgettext_lazy(
            "IATI codelist PolicyMarker", "Participatory Development/Good Governance"
        ),
    )
    TRADE_DEVELOPMENT = (
        4,
        pgettext_lazy("IATI codelist PolicyMarker", "Trade Development"),
    )
    AID_TARGETING_THE_OBJECTIVES_OF_THE_CONVENTION_ON_BIOLOGICAL_DIVERSITY = (
        5,
        pgettext_lazy(
            "IATI codelist PolicyMarker",
    ...
    DISASTER_RISK_REDUCTION_DRR_ = (
        10,
        pgettext_lazy("IATI codelist PolicyMarker", "Disaster Risk Reduction(DRR)"),
    )
    DISABILITY = (
        11,
        pgettext_lazy("IATI codelist PolicyMarker", "Disability"),
    )
    NUTRITION = (
        12,
        pgettext_lazy("IATI codelist PolicyMarker", "Nutrition"),
    )
