...
class IATIOrganisationIdentifier(models.TextChoices):
    ...
    THE_COCA_COLA_EXPORT_CORPORATION = (
        "XI-IATI-1001",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier",
    ...
    UNITED_MISSION_TO_NEPAL = (
        "XI-IATI-1002",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "United Mission to Nepal"
        ),
    )
    ...
    AGRESULTS = (
        "XI-IATI-AGR",
        pgettext_lazy("IATI codelist IATIOrganisationIdentifier", "AgResults"),
    )
    ...
    CABI = (
        "XI-IATI-CABI",
        pgettext_lazy("IATI codelist IATIOrganisationIdentifier", "CABI"),
    )
    THE_COMMONWEALTH_SECRETARIAT = (
        "XI-IATI-CWSEC",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "The Commonwealth Secretariat"
        ),
    )
    DEMOCRATIC_GOVERNANCE_FACILITY = (
        "XI-IATI-DGF",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "Democratic Governance Facility"
        ),
    )
    ...
    LIVING_PEACE_INSTITUTE = (
        "XI-IATI-LPI",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "Living Peace Institute"
        ),
    )
    ...
    NETHERLANDS_SPACE_OFFICE = (
        "XI-IATI-NSO",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "Netherlands Space Office"
        ),
    )
    ...
    SOMALI_GENDER_JUSTICE = (
        "XI-IATI-SGJ",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "Somali Gender Justice"
        ),
    )
    SOMALI_WOMEN_STUDY_CENTRE = (
        "XI-IATI-SWSC",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "Somali Women Study Centre"
        ),
    )
    ...
    UNITED_DARFUR_COMMITTEES = (
        "XI-IATI-UDC",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "United Darfur Committees"
        ),
    )
    UN_POOLED_FUNDS = (
        "XI-IATI-UNPF",
        pgettext_lazy("IATI codelist IATIOrganisationIdentifier", "UN Pooled funds"),
    )
    ...
    WASH_ALLIANCE_INTERNATIONAL = (
        "XI-IATI-WAI",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "WASH Alliance International"
        ),
    )
    WORLD_BANK_TRUST_FUNDS__WBTF_ = (
        "XI-IATI-WBTF",
        pgettext_lazy(
            "IATI codelist IATIOrganisationIdentifier", "World Bank Trust Funds (WBTF)"
        ),
    )
    WORLD_VISION_DRC = (
        "XI-IATI-WVDRC",
        pgettext_lazy("IATI codelist IATIOrganisationIdentifier", "World Vision DRC"),
    )
