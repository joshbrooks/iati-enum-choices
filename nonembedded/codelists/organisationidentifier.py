...
class OrganisationIdentifier(models.TextChoices):
    ...
    FEDERAL_MINISTRY_OF_FINANCE = (
        "AT-1",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Federal Ministry of Finance"
        ),
    )
    MINISTRY_FOR_AGRICULTURE_AND_ENVIRONMENT = (
        "AT-10",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier",
            "Ministry for Agriculture and Environment",
        ),
    )
    MINISTRY_OF_DEFENSE = (
        "AT-11",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Ministry of Defense"),
    )
    MINISTRY_OF_INTERIOR = (
        "AT-12",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Ministry of Interior"),
    )
    VARIOUS_MINISTRIES = (
        "AT-2",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Various ministries"),
    )
    FEDERAL_GOVERNMENT_OF_AUSTRIA = (
        "AT-3",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Federal Government of Austria"
        ),
    )
    OESTERREICHISCHE_KONTROLLBANK_AG = (
        "AT-4",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Oesterreichische Kontrollbank AG"
        ),
    )
    ...
    AUSTRIAN_DEVELOPMENT_AGENCY = (
        "AT-8",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Austrian Development Agency"
        ),
    )
    EDUCATION_AND_SCIENCE_MINISTRY = (
        "AT-9",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Education and Science Ministry"
        ),
    )
    MISCELLANEOUS = (
        "AT-99",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Miscellaneous"),
    )
    ...
    DUCROIRE_NATIONAL_OFFICE = (
        "BE-31",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ducroire National Office"
        ),
    )
    OTHER_OFFICIAL_FEDERAL_SERVICES = (
        "BE-39",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Other Official Federal Services"
        ),
    )
    ...
    EXPORT_DEVELOPMENT_CORPORATION = (
        "CA-31",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Export Development Corporation"
        ),
    )
    DEPARTMENT_OF_FINANCE = (
        "CA-4",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Department of Finance"),
    )
    ...
    MUNICIPALITIES = (
        "CH-11",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Municipalities"),
    )
    ...
    FEDERAL_OFFICE_FOR_MIGRATION = (
        "CH-8",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Federal Office for Migration"
        ),
    )
    ...
    FOREIGN_OFFICE = (
        "DE-11",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Foreign Office"),
    )
    FEDERAL_STATES___LOCAL_GOVERNMENTS = (
        "DE-12",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Federal States & Local Governments"
        ),
    )
    FEDERAL_INSTITUTIONS = (
        "DE-14",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Federal Institutions"),
    )
    FEDERAL_MINISTRIES = (
        "DE-16",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Federal Ministries"),
    )
    ...
    KREDITANSTALT_FÜR_WIEDERAUFBAU = (
        "DE-2",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Kreditanstalt für Wiederaufbau"
        ),
    )
    HERMES_KREDITVERSICHERUNGS_AG = (
        "DE-34",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Hermes Kreditversicherungs-AG"
        ),
    )
    ...
    MINISTRY_OF_FOREIGN_AFFAIRS = (
        "DK-1",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Foreign Affairs"
        ),
    )
    ...
    NOT_IN_CRS_DIRECTIVES = (
        "DK-4",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Not in CRS Directives"),
    )
    EKR = (
        "DK-72",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "EKR"),
    )
    INSTITUTO_DE_CREDITO_OFICIAL = (
        "ES-1",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Instituto de Credito Oficial"
        ),
    )
    MINISTRY_OF_ENVIRONMENT = (
        "ES-10",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Environment"
        ),
    )
    MINISTRY_OF_HEALTH = (
        "ES-11",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Ministry of Health"),
    )
    ...
    MINISTRY_OF_PUBLIC_ADMINISTRATION = (
        "ES-14",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Public Administration"
        ),
    )
    ...
    MINISTRY_OF_SCIENCE_AND_TECHNOLOGY = (
        "ES-18",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Science and Technology"
        ),
    )
    MINISTRY_OF_DEFENSE = (
        "ES-19",
    ...
    AUTONOMOUS_GOVERNMENTS = (
        "ES-2",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Autonomous Governments"),
    )
    ...
    MINISTRY_OF_ECONOMY_AND_FINANCE = (
        "ES-6",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Economy and Finance"
        ),
    )
    ...
    MINISTRY_OF_PUBLIC_WORKS = (
        "ES-8",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Public Works"
        ),
    )
    MINISTRY_OF_INDUSTRY_AND_ENERGY = (
        "ES-9",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Industry and Energy"
        ),
    )
    ...
    EUROPEAN_DEVELOPMENT_FUND = (
        "EU-2",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "European Development Fund"
        ),
    )
    EUROPEAN_INVESTMENT_BANK = (
        "EU-3",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "European Investment Bank"
        ),
    )
    ...
    FINNISH_GOVERNMENT = (
        "FI-1",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Finnish Government"),
    )
    FINNFUND = (
        "FI-2",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "FinnFund"),
    )
    MINISTRY_OF_FOREIGN_AFFAIRS = (
        "FI-3",
        pgettext_lazy(
    ...
    FIDE = (
        "FI-4",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "FIDE"),
    )
    FINNVERA = (
        "FI-72",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "FinnVera"),
    )
    ...
    FRENCH_DEVELOPMENT_AGENCY = (
        "FR-3",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "French Development Agency"
        ),
    )
    COFACE = (
        "FR-43",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Coface"),
    )
    MINISTRY_OF_FOREIGN_AFFAIRS = (
        "FR-6",
        pgettext_lazy(
    ...
    CDC_CAPITAL_PARTNERS_PLC = (
        "GB-2",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "CDC Capital Partners PLC"
        ),
    )
    EXPORT_CREDIT_GUARANTEE_DEPARTMENT = (
        "GB-5",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Export Credit Guarantee Department"
        ),
    )
    MINISTRY_OF_FOREIGN_AFFAIRS = (
        "GR-1",
    ...
    MINISTRY_OF_NATIONAL_ECONOMY = (
        "GR-2",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of National Economy"
        ),
    )
    MISCELLANEOUS = (
        "GR-20",
    ...
    MINISTRY_OF_NATIONAL_DEFENCE = (
        "GR-4",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of National Defence"
        ),
    )
    ...
    MINISTRY_OF_AGRICULTURE = (
        "GR-7",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Agriculture"
        ),
    )
    MINISTRY_OF_HEALTH_WELFARE = (
        "GR-8",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Health - Welfare"
        ),
    )
    MINISTRY_OF_MERCHANT_MARINE = (
        "GR-9",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Merchant Marine"
        ),
    )
    DEPARTMENT_OF_FOREIGN_AFFAIRS = (
        "IE-1",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Department of Foreign Affairs"
        ),
    )
    ...
    CENTRAL_ADMINISTRATION = (
        "IT-7",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Central administration"),
    )
    ...
    LOCAL_ADMINISTRATION = (
        "IT-8",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Local administration"),
    )
    ARTIGIANCASSA = (
        "IT-9",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Artigiancassa"),
    )
    ...
    OTHER_MINISTRIES = (
        "JP-12",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Other Ministries"),
    )
    PUBLIC_CORPORATIONS = (
        "JP-13",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Public Corporations"),
    )
    PREFECTURES = (
        "JP-14",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Prefectures"),
    )
    ORDINANCE_DESIGNED_CITIES = (
        "JP-15",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ordinance-designed Cities"
        ),
    )
    MINISTRY_OF_FOREIGN_AFFAIRS = (
        "JP-2",
    ...
    LUX_DEVELOPMENT = (
        "LU-1",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Lux-Development"),
    )
    MINISTRY_OF_FOREIGN_AFFAIRS = (
        "LU-2",
        pgettext_lazy(
    ...
    DUCROIRE_OFFICE = (
        "LU-22",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Ducroire Office"),
    )
    MINISTRY_OF_FOREIGN_AFFAIRS__DGIS_ = (
        "NL-1",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Ministry of Foreign Affairs (DGIS)"
        ),
    )
    NCM_CREDIT_MANAGEMENT_WORLDWIDE = (
        "NL-33",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "NCM Credit Management Worldwide"
        ),
    )
    ...
    EKSPORT_FINANS = (
        "NO-72",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Eksport Finans"),
    )
    NORFUND = (
        "NO-8",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "NORFUND"),
    )
    ...
    PORTUGUESE_GOVERNMENT = (
        "PT-1",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Portuguese Government"),
    )
    ...
    OTHER = (
        "PT-3",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Other"),
    )
    CONSELHO_DE_GARANTIAS_FINANCEIRAS = (
        "PT-71",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Conselho de garantias financeiras"
        ),
    )
    MINISTRY_OF_FOREIGN_AFFAIRS = (
        "SE-2",
    ...
    PEACE_CORPS = (
        "US-10",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Peace Corps"),
    )
    STATE_DEPARTMENT = (
        "US-11",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "State Department"),
    )
    TRADE_AND_DEVELOPMENT_AGENCY = (
        "US-12",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Trade and Development Agency"
        ),
    )
    AFRICAN_DEVELOPMENT_FOUNDATION = (
        "US-13",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "African Development Foundation"
        ),
    )
    ...
    NATIONAL_INSTITUTES_OF_HEALTH = (
        "US-16",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "National Institutes of Health"
        ),
    )
    DEPARTMENT_OF_LABOR = (
        "US-17",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Department of Labor"),
    )
    DEPARTMENT_OF_AGRICULTURE = (
        "US-2",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Department of Agriculture"
        ),
    )
    EXPORT_IMPORT_BANK = (
        "US-31",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Export Import Bank"),
    )
    DEPARTMENT_OF_TRANSPORTATION = (
        "US-5",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Department of Transportation"
        ),
    )
    DEPARTMENT_OF_TREASURY = (
        "US-6",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Department of Treasury"),
    )
    DEPARTMENT_OF_DEFENSE = (
        "US-7",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Department of Defense"),
    )
    MISCELLANEOUS = (
        "US-8",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Miscellaneous"),
    ...
    DEPARTMENT_OF_INTERIOR = (
        "US-9",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Department of Interior"),
    )
    ...
    ECONOMIC_COMMISSION_FOR_AFRICA = (
        "41103",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Economic Commission for Africa"
        ),
    )
    ...
    UNITED_NATIONS_POPULATION_FUND = (
        "41119",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "United Nations Population Fund"
        ),
    )
    ...
    UNITED_NATIONS_CHILDREN_S_FUND = (
        "41122",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "United Nations Children's Fund"
        ),
    )
    ...
    UNITED_NATIONS_MINE_ACTION_SERVICE = (
        "41126",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "United Nations Mine Action Service"
        ),
    )
    ...
    UNITED_NATIONS_VOLUNTEERS = (
        "41135",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "United Nations Volunteers"
        ),
    )
    ...
    WORLD_FOOD_PROGRAMME = (
        "41140",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "World Food Programme"),
    )
    ...
    UNITED_NATIONS_DEMOCRACY_FUND = (
        "41142",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "United Nations Democracy Fund"
        ),
    )
    ...
    FOOD_AND_AGRICULTURAL_ORGANISATION = (
        "41301",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Food and Agricultural Organisation"
        ),
    )
    INTERNATIONAL_LABOUR_ORGANISATION = (
        "41302",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "International Labour Organisation"
        ),
    )
    ...
    UNITED_NATIONS = (
        "41305",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "United Nations"),
    )
    UNIVERSAL_POSTAL_UNION = (
        "41306",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Universal Postal Union"),
    )
    ...
    WORLD_METEOROLOGICAL_ORGANISATION = (
        "41309",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "World Meteorological Organisation"
        ),
    )
    ...
    INTERNATIONAL_FINANCE_CORPORATION = (
        "44004",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "International Finance Corporation"
        ),
    )
    ...
    ADVANCE_MARKET_COMMITMENTS = (
        "44006",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Advance Market Commitments"
        ),
    )
    ...
    AFRICAN_SOLIDARITY_FUND = (
        "46001",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "African Solidarity Fund"
        ),
    )
    AFRICAN_DEVELOPMENT_BANK = (
        "46002",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "African Development Bank"
        ),
    )
    AFRICAN_DEVELOPMENT_FUND = (
        "46003",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "African Development Fund"
        ),
    )
    ASIAN_DEVELOPMENT_BANK = (
        "46004",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Asian Development Bank"),
    )
    ASIAN_DEVELOPMENT_FUND = (
        "46005",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Asian Development Fund"),
    )
    ...
    ANDEAN_DEVELOPMENT_CORPORATION = (
        "46008",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Andean Development Corporation"
        ),
    )
    CARIBBEAN_DEVELOPMENT_BANK = (
        "46009",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Caribbean Development Bank"
        ),
    )
    ...
    ASIAN_PRODUCTIVITY_ORGANISATION = (
        "47002",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Asian Productivity Organisation"
        ),
    )
    ...
    ASEAN_CULTURAL_FUND = (
        "47004",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "ASEAN Cultural Fund"),
    )
    ...
    WORLD_VEGETABLE_CENTRE = (
        "47008",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "World Vegetable Centre"),
    )
    ...
    CARIBBEAN_COMMUNITY_SECRETARIAT = (
        "47011",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Caribbean Community Secretariat"
        ),
    )
    CARIBBEAN_EPIDEMIOLOGY_CENTRE = (
        "47012",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Caribbean Epidemiology Centre"
        ),
    )
    COMMONWEALTH_FOUNDATION = (
        "47013",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Commonwealth Foundation"
        ),
    )
    ...
    COMMONWEALTH_INSTITUTE = (
        "47016",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Commonwealth Institute"),
    )
    ...
    INTERNATIONAL_POTATO_CENTRE = (
        "47021",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "International Potato Centre"
        ),
    )
    ...
    COMMONWEALTH_OF_LEARNING = (
        "47025",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Commonwealth of Learning"
        ),
    )
    ...
    COLOMBO_PLAN = (
        "47027",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Colombo Plan"),
    )
    ...
    SAHEL_AND_WEST_AFRICA_CLUB = (
        "47029",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Sahel and West Africa Club"
        ),
    )
    COMMONWEALTH_SCIENTIFIC_COUNCIL = (
        "47030",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Commonwealth Scientific Council"
        ),
    )
    COMMONWEALTH_SMALL_STATES_OFFICE = (
        "47031",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Commonwealth Small States Office"
        ),
    )
    ...
    COMMONWEALTH_YOUTH_PROGRAMME = (
        "47033",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Commonwealth Youth Programme"
        ),
    )
    ...
    FORUM_FISHERIES_AGENCY = (
        "47040",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Forum Fisheries Agency"),
    )
    ...
    GLOBAL_CROP_DIVERSITY_TRUST = (
        "47043",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Global Crop Diversity Trust"
        ),
    )
    GLOBAL_ENVIRONMENT_FACILITY = (
        "47044",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Global Environment Facility"
        ),
    )
    ...
    INTERNATIONAL_AFRICAN_INSTITUTE = (
        "47047",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "International African Institute"
        ),
    )
    INTER_AMERICAN_INDIAN_INSTITUTE = (
        "47048",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Inter-American Indian Institute"
        ),
    )
    ...
    WORLD_AGROFORESTRY_CENTRE = (
        "47056",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "World AgroForestry Centre"
        ),
    )
    ...
    INTERNATIONAL_INSTITUTE_FOR_COTTON = (
        "47060",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "International Institute for Cotton"
        ),
    )
    ...
    ASIA_PACIFIC_FISHERY_COMMISSION = (
        "47068",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Asia-Pacific Fishery Commission"
        ),
    )
    BIODIVERSITY_INTERNATIONAL = (
        "47069",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Biodiversity International"
        ),
    )
    ...
    INTERNATIONAL_VACCINE_INSTITUTE = (
        "47074",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "International Vaccine Institute"
        ),
    )
    ...
    MEKONG_RIVER_COMMISSION = (
        "47077",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Mekong River Commission"
        ),
    )
    ...
    ORGANISATION_OF_AMERICAN_STATES = (
        "47079",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Organisation of American States"
        ),
    )
    ...
    OECD_DEVELOPMENT_CENTRE = (
        "47081",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "OECD Development Centre"
        ),
    )
    ...
    PAN_AMERICAN_HEALTH_ORGANISATION = (
        "47083",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Pan-American Health Organisation"
        ),
    )
    ...
    PACIFIC_ISLANDS_FORUM_SECRETARIAT = (
        "47087",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Pacific Islands Forum Secretariat"
        ),
    )
    RELIEF_NET = (
        "47088",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Relief Net"),
    )
    ...
    UNIVERSITY_OF_THE_SOUTH_PACIFIC = (
        "47099",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "University of the South Pacific"
        ),
    )
    WEST_AFRICAN_MONETARY_UNION = (
        "47100",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "West African Monetary Union"
        ),
    )
    AFRICA_RICE_CENTRE = (
        "47101",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Africa Rice Centre"),
    )
    ...
    WORLD_MARITIME_UNIVERSITY = (
        "47103",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "World Maritime University"
        ),
    )
    WORLDFISH_CENTRE = (
        "47104",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "WorldFish Centre"),
    )
    COMMON_FUND_FOR_COMMODITIES = (
        "47105",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Common Fund for Commodities"
        ),
    )
    ...
    ADAPTATION_FUND = (
        "47111",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Adaptation Fund"),
    )
    ...
    SAHARA_AND_SAHEL_OBSERVATORY = (
        "47119",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Sahara and Sahel Observatory"
        ),
    )
    ...
    LATIN_AMERICAN_ENERGY_ORGANISATION = (
        "47127",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Latin-American Energy Organisation"
        ),
    )
    ...
    DEVELOPMENT_GATEWAY_FOUNDATION = (
        "21006",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Development Gateway Foundation"
        ),
    )
    ...
    EUROSTEP = (
        "21008",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Eurostep"),
    )
    ...
    GLOBAL_CAMPAIGN_FOR_EDUCATION = (
        "21011",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Global Campaign for Education"
        ),
    )
    HEALTH_ACTION_INTERNATIONAL = (
        "21013",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Health Action International"
        ),
    )
    ...
    INTERNATIONAL_HIV_AIDS_ALLIANCE = (
        "21020",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "International HIV/AIDS Alliance"
        ),
    )
    ...
    INTERNATIONAL_SEISMOLOGICAL_CENTRE = (
        "21025",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "International Seismological Centre"
        ),
    )
    ...
    DOCTORS_WITHOUT_BORDERS = (
        "21029",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Doctors Without Borders"
        ),
    )
    ...
    PANOS_INSTITUTE = (
        "21031",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "PANOS Institute"),
    )
    POPULATION_SERVICES_INTERNATIONAL = (
        "21032",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Population Services International"
        ),
    )
    TRANSPARENCY_INTERNATIONAL = (
        "21033",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Transparency International"
        ),
    )
    ...
    WORLD_ORGANISATION_AGAINST_TORTURE = (
        "21035",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "World Organisation Against Torture"
        ),
    )
    WORLD_UNIVERSITY_SERVICE = (
        "21036",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "World University Service"
        ),
    )
    WOMEN_S_WORLD_BANKING = (
        "21037",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Women's World Banking"),
    )
    INTERNATIONAL_ALERT = (
        "21038",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "International Alert"),
    )
    ...
    AGRICORD = (
        "21047",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "AgriCord"),
    )
    ...
    GENEVA_CALL = (
        "21050",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Geneva Call"),
    )
    ...
    LIFE_AND_PEACE_INSTITUTE = (
        "21054",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Life and Peace Institute"
        ),
    )
    REGIONAL_AIDS_TRAINING_NETWORK = (
        "21055",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Regional AIDS Training Network"
        ),
    )
    ...
    GLOBAL_WATER_PARTNERSHIP = (
        "30004",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Global Water Partnership"
        ),
    )
    ...
    CITIES_ALLIANCE = (
        "30008",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Cities Alliance"),
    )
    SMALL_ARMS_SURVEY = (
        "30009",
        pgettext_lazy("IATI codelist OrganisationIdentifier", "Small Arms Survey"),
    )
    ...
    GLOBAL_DEVELOPMENT_NETWORK = (
        "31001",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Global Development Network"
        ),
    )
    GLOBAL_KNOWLEDGE_PARTNERSHIP = (
        "31002",
        pgettext_lazy(
            "IATI codelist OrganisationIdentifier", "Global Knowledge Partnership"
        ),
    )
