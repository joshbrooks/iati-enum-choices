...
class FlowTypeDescription(models.IntegerChoices):
    ...
    ODA = (
        10,
        pgettext_lazy(
            "IATI codelist FlowType description", "Official Development Assistance"
        ),
    )
    OOF = (
        20,
        pgettext_lazy("IATI codelist FlowType description", "Other Official Flows"),
    )
    NON_EXPORT_CREDIT_OOF = (
        21,
        pgettext_lazy(
            "IATI codelist FlowType description",
    ...
    PRIVATE_FOREIGN_DIRECT_INVESTMENT = (
        36,
        pgettext_lazy(
            "IATI codelist FlowType description", "Private Foreign Direct Investment"
        ),
    )
    ...
    NON_FLOW = (
        40,
        pgettext_lazy(
            "IATI codelist FlowType description", "e.g. GNI, ODA%GNI, Population etc"
        ),
    )
    OTHER_FLOWS = (
        50,
