...
class SectorDescription(models.IntegerChoices):
    ...
    PRIMARY_EDUCATION_EQUIVALENT_FOR_ADULTS = (
        11232,
        pgettext_lazy("Sector description", "Formal primary education for adults."),
    )
    ...
    MALARIA_CONTROL = (
        12262,
        pgettext_lazy("Sector description", "Prevention and control of malaria."),
    )
    ...
    POLICE = (
        15132,
        pgettext_lazy("Sector description", "Police affairs and services."),
    )
    ...
    LOWCOST_HOUSING = (
        16040,
        pgettext_lazy("Sector description", "Including slum clearance."),
    )
    ...
    CULTURE_AND_RECREATION = (
        16061,
        pgettext_lazy("Sector description", "Including libraries and museums."),
    )
    ...
    INFORMATION_SERVICES = (
        22013,
        pgettext_lazy("Sector description", "Provision of information services."),
    )
    TELECOMMUNICATIONS = (
        22020,
        pgettext_lazy(
    ...
    GAS_DISTRIBUTION = (
        23050,
        pgettext_lazy("Sector description", "Delivery for use by ultimate consumer."),
    )
    OIL_FIRED_POWER_PLANTS = (
        23061,
        pgettext_lazy("Sector description", "Including diesel power plants."),
    )
    NUCLEAR_POWER_PLANTS = (
        23064,
        pgettext_lazy("Sector description", "Including nuclear safety."),
    )
    ...
    MONETARY_INSTITUTIONS = (
        24020,
        pgettext_lazy("Sector description", "Central banks."),
    )
    ...
    AGRICULTURAL_DEVELOPMENT = (
        31120,
        pgettext_lazy("Sector description", "Integrated projects; farm development."),
    )
    ...
    LIVESTOCK = (
        31163,
        pgettext_lazy("Sector description", "Animal husbandry; animal feed aid."),
    )
    AGRARIAN_REFORM = (
        31164,
        pgettext_lazy(
    ...
    AGRICULTURAL_EXTENSION = (
        31166,
        pgettext_lazy("Sector description", "Non-formal training in agriculture."),
    )
    ...
    AGRICULTURAL_CO_OPERATIVES = (
        31194,
        pgettext_lazy("Sector description", "Including farmers’ organisations."),
    )
    ...
    TEXTILES__LEATHER_AND_SUBSTITUTES = (
        32163,
        pgettext_lazy("Sector description", "Including knitting factories."),
    )
    CHEMICALS = (
        32164,
        pgettext_lazy(
    ...
    COAL = (
        32261,
        pgettext_lazy("Sector description", "Including lignite and peat."),
    )
    ...
    FERROUS_METALS = (
        32263,
        pgettext_lazy("Sector description", "Iron and ferro-alloy metals."),
    )
    NONFERROUS_METALS = (
        32264,
        pgettext_lazy(
    ...
    FERTILIZER_MINERALS = (
        32267,
        pgettext_lazy("Sector description", "Phosphates, potash."),
    )
    OFFSHORE_MINERALS = (
        32268,
        pgettext_lazy(
    ...
    MULTISECTOR_EDUCATION_TRAINING = (
        43081,
        pgettext_lazy("Sector description", "Including scholarships."),
    )
    RESEARCH_SCIENTIFIC_INSTITUTIONS = (
        43082,
        pgettext_lazy("Sector description", "When sector cannot be identified."),
    )
    ...
    SUPPORT_TO_NATIONAL_NGOS = (
        92010,
        pgettext_lazy("Sector description", "In the donor country."),
    )
    SUPPORT_TO_LOCAL_AND_REGIONAL_NGOS = (
        92030,
        pgettext_lazy("Sector description", "In the recipient country or region."),
    )
